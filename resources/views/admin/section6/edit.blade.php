        ...
        <div class="card-body">
            <form action="{{ route('section6.update',['section6'=>$section6->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @error('phone') <div class="text-danger text-center">Required value</div>@enderror
                </div>
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Locate: </label>
                    <input type="text" name="location" class="form-control" value="{{ $section6->location }}">
                    @error('location') <div class="text-danger text-center">Required value</div>@enderror
                </div>
