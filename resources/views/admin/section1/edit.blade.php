    ...
    <div class="card border border-dark">
        ...
        <div class="card-body">
            <form action="{{ route('section1.update',['section1'=>$section1->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Primary text:</label>
                    <input type="text" name="title1" class="form-control" value="{{ $section1->title1 }}">
                    @error('title1') <div class="text-danger text-center">Required value</div>@enderror
                </div>

                <div class="mb-3">
                    <label for="title" class="form-label">Secondary text: </label>
                    <input type="text" name="title2" class="form-control" value="{{ $section1->title2 }}">
                    @error('title2') <div class="text-danger text-center">Required value</div>@enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @error('lb_btn_sctn2') <div class="text-danger text-center">Required value</div>@enderror
                </div>
