    ...
    <div class="card border border-dark">
        ...
        <div class="card-body">
            <form action="{{ route('footer.update',['footer'=>$footer->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Symbol: </label>
                    <input type="text" name="symbol" class="form-control" value="{{ $footer->symbol }}">
                    @error('symbol') <div class="text-danger text-center">Required value</div>@enderror
                </div>
                ...
                <div class="input-group">
                    <div class="mr-5 mb-3">
                        ...
                        @error('year') <div class="text-danger text-center">Required value</div>@enderror
                    </div>

                    <div class="ml-4 mb-5">
                        <label for="title" class="form-label">Owner: </label>
                        <input type="text" name="owner" class="form-control" value="{{ $footer->owner }}">
                        @error('owner') <div class="text-danger text-center">Required value</div>@enderror
                    </div>
                </div>


                <div>
                    <label for="title" class="form-label">Current image background: </label>
                </div>
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Other details: &nbsp;&nbsp;&nbsp;[opcionals]</label>
