        ...
        <div class="card-body">
            ...
            <form action="{{ route('section3.update',['section3'=>$section3->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 table-responsive">
                    <label for="title" class="form-label"><strong>Description: </strong></label>
                    <table class="w-100">
                ...
                <table class="table">
                    <thead>
                        <tr class="bg-light table-sm">
                            ...
                            <th scope="col" class="text-center">Related Images</th>
                            <th scope="col"></th>
                            <th scope="col"></th>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <form action="{{ route('section3_categories.destroy',[$section3_category->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-link" onclick="return confirm('Are yo sure to delete category: {{$section3_category->name}}?. All elements asociated whit this catergory, will be deleted too.')">
