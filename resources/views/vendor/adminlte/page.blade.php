            ...
            <nav class="pt-2">
                ...
                <h6>OPCIONES DE AJUSTES</h6>
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link" href="{{route('navbar.edit', ['navbar' => 1])}}" <p><i class="fa fa-window-maximize fa-lg"></i>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; NAVBAR </p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link" href="{{route('social_network.index', ['social_network' => 1])}}" <p><i class="fa fa-users    fa-lg"></i>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Social Networks </p>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('footer.edit', ['footer' => 1])}}" <p>&nbsp;<i class="fa fa-angle-double-down fa-lg"></i>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;Footer </p>
                        </a>
                    </li>
