				...
				<table id="dtHorizontalExample" class="table table-striped table-bordered table-sm table-hover" cellspacing="0" width="100%">
					<thead>
						<tr class="bg-primary">
							...
							<th class="text-center">View on gallery</th>
				...
				<div class="col-md-12 col-sm-12">
					<form action="{{ route('send-email') }}" method="POST">
						...
						<div class="col-md-6 col-sm-6">
							...
							@error('name') <script>document.location.href = "#section_email"</script><div class="text-danger text-center">Required value</div>@enderror

							<input name="email" type="email" class="form-control" id="email" placeholder="Email">
							@error('email') <script>document.location.href = "#section_email"</script><div class="text-danger text-center">Required value. This field must be a valid email format</div>@enderror

							<input name="subject" type="text" class="form-control" id="subject" placeholder="Subject">
							@error('subject') <script>document.location.href = "#section_email"</script><div class="text-danger text-center">Required value</div>@enderror
						</div>
						<div class="col-md-6 col-sm-6">
							<textarea name="message" rows="7" class="form-control" id="message" placeholder="Message"></textarea>
							@error('message') <script>document.location.href = "#section_email"</script><div class="text-danger text-center">Required value</div>@enderror
						</div>
