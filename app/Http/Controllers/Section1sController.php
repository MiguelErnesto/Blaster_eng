    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("url_img")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section1.edit', ['section1' => 1])->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
        ...
        $section1->save();
        return redirect()->route('home')->with('success', 'Section: ' . config('app.nav_section1') . ' updated successfully.');
    }
