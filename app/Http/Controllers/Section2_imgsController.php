    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section2_img.create')->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("url_img")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section2_img.edit', ['section2_img' => 1])->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
        ...
        return redirect()->route('section2.edit', ['section2' => 1])->with('success', 'Section:  ' . config('app.nav_section2') . ' updated successfully.');
    }
