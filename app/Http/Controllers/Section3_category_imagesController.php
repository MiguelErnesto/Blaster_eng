    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section3_category_images.create')->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("url_img")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section3_category_images.edit', ['section3_category_images' => 1])->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
