    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section4_images.create')->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
        ...
        return redirect()->route('section4.edit', ['section4' => 1])->with('success', 'Section: ' . config('app.nav_section4') . ' updated successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("url_img")) {
            ...
            if (($ext == "jpeg") or ($ext == "png") or ($ext == "jpg") or ($ext == "gif") or ($ext == "svg")) {
                ...
                return redirect()->route('section4_images.edit', ['section4_images' => 1])->with('success', 'Choices a valid image (jpeg, png, jpg, gif, svg)');
            }
        }
