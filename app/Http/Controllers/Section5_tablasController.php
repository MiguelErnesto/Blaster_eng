...
class Section5_tablasController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.section5_tabla.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('section5.edit', ['section5' => 1])
            ->with(
                'success',
                'Section: ' .
    ...
    public function edit($id)
    {
        ...
        $section5_category_name = section3_categories::where(
            'id',
            $section5_tabla->section3_category_id
        )->get();
        $categories = section3_categories::all();
