...
class NavbarsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $navbar->save();
        return redirect()->route('home')->with('success', 'NAVBAR  updated successfully.');
        //return redirect()->route('navbar.edit', ['navbar' => $navbar])->with('success', 'NAVBAR actualizado correctamente.');
    }
